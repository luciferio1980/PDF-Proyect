...
https://github.com/luciferio1980/PDF-Proyect/releases/tag/v0.2.6-alpha
...
- Search
- Edit native PDF text by drawing a selection box (recognizes font and text; not a white overlay)
